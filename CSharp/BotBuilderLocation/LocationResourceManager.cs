namespace Microsoft.Bot.Builder.Location
{
    ...
    public class LocationResourceManager
    {
        ...
        /// <summary>
        /// The <see cref="FavoriteAdditionConfirmation"/> resource string.
        /// </summary>
        public virtual string FavoriteAdditionConfirmation => this.GetResource(nameof(Strings.FavoriteAdditionConfirmation));

        /// <summary>
        /// The <see cref="FavoriteLocation"/> resource string.
        /// </summary>
        public virtual string FavoriteLocation => this.GetResource(nameof(Strings.FavoriteLocation));

        /// <summary>
        /// The <see cref="FavoriteLocationsFound" /> resource string.
        /// </summary>
        public virtual string FavoriteLocationsFound => this.GetResource(nameof(Strings.FavoriteLocationsFound));
        ...
        /// <summary>
        /// The <see cref="InvalidFavoriteLocationResponse"/> resource string.
        /// </summary>
        public virtual string InvalidFavoriteLocationResponse => this.GetResource(nameof(Strings.InvalidFavoriteLocationResponse));

        /// <summary>
        /// The <see cref="InvalidEmptyFavoriteLocationsResponse"/> resource string.
        /// </summary>
        public virtual string InvalidEmptyFavoriteLocationsResponse => this.GetResource(nameof(Strings.InvalidEmptyFavoriteLocationsResponse));
        ...
        /// <summary>
        /// The <see cref="NewCommand"/> resource string.
        /// </summary>
        public virtual string NewCommand => this.GetResource(nameof(Strings.NewCommand));
